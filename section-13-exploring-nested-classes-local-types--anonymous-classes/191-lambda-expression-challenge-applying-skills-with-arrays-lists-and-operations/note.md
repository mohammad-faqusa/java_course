...
#### the challenge 
1. create an array of string (first names)
2. include at least which spelled same backwards , for example Bob ar Anna
3. use **Arrays.setAll** or **List.replaceAll** 
4. methods: 
   * transofrm to uppercase 
