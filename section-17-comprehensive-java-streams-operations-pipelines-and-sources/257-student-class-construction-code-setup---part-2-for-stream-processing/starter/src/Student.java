...
public class Student {
    ...
    private final boolean programmingExperiance;
    private final Map<String, CourseEngagement> engagementMap = new HashMap<>();

    public Student(String countryCode,
                   int yearEnrolled, int ageEnrolled, String gender,
                   boolean programmingExperiance, Course... courses) {
        ...
        this.gender = gender;
        this.programmingExperiance = programmingExperiance;
    ...
    public boolean hasProgrammingExperiance() {
        return programmingExperiance;
    }
    ...
    public String toString() {
        return "Student{" +
                ...
                ", gender='" + gender + '\'' +
                ", programmingExperiance=" + programmingExperiance +
